...
const Error404 = () => {
    return (
        <div className="error-pg-container" data-testid='error-1'>
            {/* <h1 className='title'>404</h1> */}
            <img className='error_image' src={error} />
            <h3 className='error_message'><i className="bi bi-dash-circle-fill"><DashCircleFill /></i> Sorry, this page cannot be found! <i className="bi bi-dash-circle-fill"><DashCircleFill /></i></h3>
